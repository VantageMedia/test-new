        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          <div className="col-span-1">
            ...
            <p className="text-sm text-gray-600 mb-4">
              Copyright © 2023 Vantage Media Inc.<br />
              All rights reserved.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-600 hover:text-blue-500">Legal</a></li>
          ...
          <div>
            ...
            <div className="flex">
              <input type="email" placeholder="Your email address" className="flex-1 px-4 py-2 rounded-l-md border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500" />
              <Button className="bg-blue-500 hover:bg-blue-600 text-white rounded-l-none rounded-r-md">
