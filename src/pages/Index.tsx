        ...
        <main>
          ...
          <section className="relative w-full py-28 px-4 bg-gradient-to-br from-[#f5f7fa] via-[#eef2ff] to-[#e0e7ff] overflow-hidden">
            ...
            <div className="max-w-5xl mx-auto flex flex-col items-center gap-12 relative z-10">
              ...
              {/* Below: Three cards */}
              <div className="grid grid-cols-1 md:grid-cols-3 gap-12 w-full max-w-[1400px] mx-auto">
                {/* Invoice and payment system card */}
                <div className="bg-white/95 border border-[#6366f1]/20 rounded-2xl p-12 flex flex-col items-center min-h-[420px] will-change-transform animate-bounce-slow backdrop-blur-sm">
                  <h3 className="text-2xl font-bold mb-10 text-gray-900 text-center">Invoice and payment system</h3>
                  <div className="flex flex-row items-center justify-between w-full h-96 relative overflow-visible">
                    {/* iPhone - large, left, cut off by border */}
                    <div className="flex-shrink-0 -ml-32 z-10">
                      <img
                        src="/iphone.avif"
                        alt="iPhone"
                    ...
                    <div className="flex-shrink-0 -mr-32 z-10">
                      <img
                        src="/fixedpos.png"
                        alt="POS System"
                ...
                <div className="bg-white/95 border border-[#6366f1]/20 rounded-2xl p-12 flex flex-col items-center min-h-[420px] will-change-transform animate-bounce-slow backdrop-blur-sm overflow-hidden">
                  <h3 className="text-2xl font-bold mb-10 text-gray-900 text-center">Integrate with leading platforms</h3>
                  <div className="flex justify-center w-full">
                    <div className={`grid grid-cols-3 w-full gap-x-12 gap-y-10 justify-items-center items-center mb-4 ${isShuffling ? 'card-shuffle' : ''}`} style={{minHeight: '260px'}}>
                      {shuffledLogos.map((src) => (
                        <div key={src} className="bg-white rounded-xl flex items-center justify-center w-32 h-32 shadow-md">
